...
public class PortatilController {
    ...
    private void mostrarDetallesCarboxiterapia(ActionEvent event) throws IOException {
        mostrarDetallesEquipo(event, "/com/example/tgt_proyecto/maquinaria/Portatil/mostrarDetallesCarboxiterapia.fxml");
    }
    ...
    private void mostrarDetallesVaporOzono(ActionEvent event) throws IOException {
        mostrarDetallesEquipo(event, "/com/example/tgt_proyecto/maquinaria/Portatil/mostrarDetallesVaporOzono.fxml");
    }
